...
```{r}
res <- wilcox.test(data_test_d2$log_pop_2009, data_test_d2$log_pop_2014, paired = TRUE)
res
...
point <- read.csv2(file = "data/noeuds.csv", encoding = "UTF-8")
lien <- read.csv2(file = "data/liens.csv", encoding = "UTF-8")
